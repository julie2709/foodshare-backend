 ...
 */
final class Version20260320024530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE donation_request CHANGE status status VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE donation_request CHANGE status status VARCHAR(20) NOT NULL');
