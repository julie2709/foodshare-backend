 ...
 */
final class Version20260320040944 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(50) NOT NULL, title VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, data JSON DEFAULT NULL, is_read TINYINT NOT NULL, created_at DATETIME NOT NULL, recipient_id INT NOT NULL, actor_id INT DEFAULT NULL, listing_id INT DEFAULT NULL, donation_request_id INT DEFAULT NULL, INDEX IDX_BF5476CAE92F8F78 (recipient_id), INDEX IDX_BF5476CA10DAF24A (actor_id), INDEX IDX_BF5476CAD4619D1A (listing_id), INDEX IDX_BF5476CAE04907ED (donation_request_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE notification ADD CONSTRAINT FK_BF5476CAD4619D1A FOREIGN KEY (listing_id) REFERENCES listing (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE notification ADD CONSTRAINT FK_BF5476CAE04907ED FOREIGN KEY (donation_request_id) REFERENCES donation_request (id) ON DELETE SET NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification DROP FOREIGN KEY FK_BF5476CAD4619D1A');
        $this->addSql('ALTER TABLE notification DROP FOREIGN KEY FK_BF5476CAE04907ED');
